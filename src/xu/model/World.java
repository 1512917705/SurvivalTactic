...
public class World {
	/*
	 * 每个生物的速度分为，移动速度，施法速度， 如果此回合选择移动，那么行动时候，减去的行动点数，是移动速度。
	 * 如果此回合选择施法，那么行动时候，减去的行动点数，是施法速度 未完成
	 * 
	 * 天启，生物的某个基因组被我们写好的基因组替换 未完成
	 */
	...
	/*
	 * 测试创造世界 public World( ) { creatureMap = new Creature[100][100]; Max_x =
	 * 99; Max_y = 99; round = 0; fight = 1; player = new Creature();
	 * creatureMap[5][5]=player; player.setX(5); player.setY(5);
	 * 
	 * creList.add(player); }
	 */
